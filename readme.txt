...
*** SUPPORT FOR THIS PLUGIN HAS BEEN DISCONTINUED ALTHOUGH IT CONTINUES TO WORK FOR MANY USERS ***

*** Consider using the Real-Time Find and Replace plugin (https://wordpress.org/plugins/real-time-find-and-replace/) which can achieve the same end result albeit in a different manner ***
